################################################################
#  $Id: 98_readingsWatcher.pm 25053 2022-01-29 Beta-User $
################################################################
#
#  98_readingsWatcher
#
...
sub Define {
    ...
    if (defined($noglobal) && ($noglobal  eq 'noglobal')) {
        ...
        addToAttrList('readingsWatcher','readingsWatcher');
        $hash->{DEF} = 'global'; # global -> userattr
    }

    $hash->{SVN}  = (qw($Id: 98_readingsWatcher.pm 25053 2021-10-07 07:39:29Z Wzut $))[2];
...
<ul>
  ...
  <ul>
    ...
    <br>
    Defines a readingsWatcher device.<br>
  </ul>
 
  <a id="readingsWatcher-set"></a>
   <h4>Set</h4>
   <ul>
   <li>active</li>
   <li>inactive</li>
  ...
  <a id="readingsWatcher-get"></a>
   <h4>Get</h4>
   <ul>
   devices
   </ul>

  <a id="readingsWatcher-attr"></a>
  <h4>Attributes</h4>
  <ul>
    <li>Attributes for the readingsWatcher device itself:</li>
     <br>
     <ul>
       <a id="readingsWatcher-attr-delimiter"><li><b>delimiter </b><br>separator for reading names (e.g. device_reading) (default _)</li><br>
       <a id="readingsWatcher-attr-disable"></a><li><b>disable</b><br>deactivate/activate the device</li><br>
       <a id="readingsWatcher-attr-interval"></a><li><b>interval &lt;seconds&gt;</b><br>Time interval for continuous check (default 60)</li><br>
       <a id="readingsWatcher-attr-deleteUnusedReadings"></a><li><b>deleteUnusedReadings</b><br>delete unused readings (default 1)</li><br>
       <a id="readingsWatcher-attr-readingActivity"></a><li><b>readingActivity</b> (default none)<br>
       ...
       <code>attr &lt;name&gt; readingActivity activity</code><br>
       Creates the additional reading activity in the monitored devices and supplies it with the status dead or alive<br>     
    ...
    <a id="readingsWatcher-attr-readingsWatcher" ></a><li><b>readingsWatcher</b><br>
...
<ul>
  ...
  <ul>
    ...
    Danach besitzt jedes FHEM Device das neue globale Attribut <a href="#readingsWatcher-attr-readingsWatcher">readingsWatcher</a>, über das im Detail eingestellt werden kann, wie readingsWatcher das Device behandeln soll.<br>
  </ul>
  ...
  <h4>Attribute</h4>
  <ul>
    <li>Attribute am readingsWatcher-Gerät selbst:<br></li>
     <ul>
       <a id="readingsWatcher-attr-delimiter"></a><li><b>delimiter</b><br>Trennzeichen für Reading Namen (z.b. device_reading) default _ </li><br>
       <a id="readingsWatcher-attr-disable"></a><li><b>disable</b><br>Deaktiviert das Device</li><br>
       <a id="readingsWatcher-attr-interval"></a><li><b>interval &lt;Sekunden&gt;</b> (default 60)<br>Zeitintervall zur kontinuierlichen Überprüfung</li><br>
       <a id="readingsWatcher-attr-deleteUnusedReadings"></a><li><b>deleteUnusedReadings</b> (default 1)<br>Readings mit dem Wert unused werden automatisch gelöscht</li><br>
       <a id="readingsWatcher-attr-readingActivity" ></a><li><b>readingActivity</b> (default none)<br>
       ...
       <code>attr &lt;name&gt; readingActivity activity</code><br>
       Erzeugt in den überwachten Geräten das zusäzliche Reading activity und versorgt es mit dem Status dead bzw alive<br>     
    ...
    Sollen Readings nur auf ihre Aktualisierung überwacht, deren Wert aber <b>nicht</b> überschrieben werden,<br>
