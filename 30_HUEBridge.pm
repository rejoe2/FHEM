...
<ul>
  ...
  <b>Set</b>
  <ul>
    <a id="HUEBridge-set-autocreate"></a>
    ...
    <a id="HUEBridge-set-autodetect"></a>
    <li>autodetect<br>
  ...
  <ul>
    ...
    <a id="HUEBridge-attr-pollDevices"></a>
    <li>pollDevices<br>
      ...
      default is 1.</li>
    <a id="HUEBridge-attr-createGroupReadings"></a>
